const documentationBuilt = [
  { title: "Lumana Documentation", platform: "Lumana", date: "2026", sortDate: "2025-06-01", summary: "Product and developer documentation for Lumana’s AI video-security platform, covering setup, configuration, and technical onboarding.", tags: ["AI", "Developer Docs", "Enterprise"], url: "" },
  ...
  { title: "Flutterwave Developer Documentation", platform: "Flutterwave", date: "2023", sortDate: "2024-06-01", summary: "Getting-started guides and API documentation for payment integrations, transfers, and verification flows.", tags: ["Fintech", "Payments", "API"], url: "https://developer.flutterwave.com/docs/getting-started" },
  ...
  { title: "Celo Developer Documentation", platform: "Celo Foundation", date: "2022", sortDate: "2023-06-01", summary: "Guides, references, and onboarding paths for builders in the Celo ecosystem.", tags: ["Web3", "Blockchain", "Smart Contracts"], url: "https://docs.celo.org/developer" },
];
